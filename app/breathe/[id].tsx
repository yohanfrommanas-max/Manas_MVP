...
function createStyles(C: Colors) { return StyleSheet.create({
  ...
  phasesPreview: { gap: 8 },
  phaseRow: { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: C.cardAlt, borderRadius: 12, padding: 14, borderWidth: 1 },
  ...
  durationChip: { flex: 1, paddingVertical: 12, borderRadius: 12, alignItems: 'center', borderWidth: 1, borderColor: C.border, backgroundColor: C.cardAlt },
  ...
  progressBarTrack: { width: '100%', height: 4, backgroundColor: C.border, borderRadius: 2, overflow: 'hidden' },
